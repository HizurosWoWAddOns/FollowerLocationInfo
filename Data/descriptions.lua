...
--[=[ 946 Talador ]=]
	desc[154] = { -- 946, 154, Magister Serenaa (A) / Magister Krelas (H)
		nil,
		{
			zone = 946,
	...
	desc[155] = { --  946, 155, Miall (A) / Morketh Bladehowl (H)
		nil,
		{
			zone = 946,
	...
	desc[171] = { --  946, 171, Pleasure-Bot 8000
		nil,
		{
			zone = 946,
	...
	desc[190] = { --  946, 190, Image of Archmage Vargoth
		{
			zone=946,
			{"Items",
				{110459, 949, 39.7, 39.9},
				{110469, 941, 68.0, 19.0},
	...
	desc[205] = { --  946, 205, Soulbinder Tuulani
		nil,
		{
			zone=946,
			{"Quests", 
	...
	desc[207] = { --  946, 207, Defender Illona (A) / Aeda Brightdawn (H)
		nil,
		{
			zone=946,
			{"Quests",
	...
	desc[466] = { --  946, 466, Garona Halforcen
		{
			zone = 946,
			--[[
			{"Quests",
...
--[=[ 947 Shadowmoon Valley ]=]
	desc[179] = { --  947, 179, Artificer Romuul (A) / Weaponsmith Na'Shral (H)
		nil,
		{
			zone = 947,
			{"Quests",
	...
	desc[180] = { --  947, 180, Fiona (A) / Shadow Hunter Rala (H)
		nil,
		{
			zone = 947,
			{"Quests",
	...
	desc[182] = {	-- 947, 182, Shelly Hamby (A)
		nil,
		{
			zone = 947,
			{"Quests",
	...
	desc[184] = {	-- 947, 184, Apprentice Artificer Andren (A) / Kal'gor the Honorable (H)
...
--[=[ 948 Spikes of Arak ]=]
	...
	desc[192] = { --  948, 192, Kimzee Pinchwhistle
		nil,
		{
			zone=948,
			{"Quests",
	...
	desc[204] = { --  948, 204, Admiral Taylor (A) / Benjamin Gibb (H)
		nil,
		{
			zone=948,
			{"Quests",
	...
	desc[218] = {	-- 948, 218, Talonpriest Ishaal
		nil,
		{
			zone=948,
			{"Achievements", 8925}
	...
	desc[224] = { --  948, 224, Talon Guard Kurekk
		{
			zone = 948,
			{"Achievements", 9072},
	...
	desc[453] = { --  948, 453, Hulda Shadowblade (A) / Dark Ranger Velonara (H)
		nil,
		{
			zone=948,
...
--[=[ 949 Gorgrond ]=]
	desc[159] = { --  949, 159, Rangani Kaalya (A) / Kaz the Shrieker (H)
		nil,
		{
			zone = 949,
			{"Quests",
	...
	desc[176] = { --  949, 176, Pitfighter Vaandaam (A) / Bruto (H)
		nil,
		{
			zone = 949,
	...
	desc[211] = { --  949, 211, Glirin (A) / Penny Clobberbottom (H)
		nil,
		{
			zone = 949,
	...
	desc[212] = { --  949, 212, Rangari Erdanii (A) / Spirit of Bony Xuk (H)
		nil,
		{
			zone=949,
			{"Requirements", {"Outpost", 949, 2}},
...
--[=[ 950 Nagrand ]=]
	desc[157] = { --  950, 157, Lantresor of the Blade
		nil,
		{
			zone = 950,
			{"Quests", 
	...
	desc[170] = { --  950, 170, Goldmane the Skinner
		{
			zone = 950,
...
--[=[ 971/976 Garrison ]=]
	...
	desc[34] = { --  971/976, 34, Qiana Moonshadow (Alliance) / Olin Umberhide (Horde)
		nil,
		{
			zone = 971,
	...
	desc[153] = { --  971/976, 153, Bruma Swiftstone (A) / Ka'la (H)
		nil,
		{
			zone = 971,
			{"Missions", 66},
	...
	desc[202] = { --  971/976, 202, Nat Pagle
		nil,
		{
			zone = 971,
			{"Requirements",
	...
	desc[216] = { --  971/976, 216, Delvar Ironfist (A) / Vivianne (H)
		nil,
		{
			zone = 971,
			{"Quests",
	...
	desc[217] = { --  971/976, 217, Thisalee Crow / Choluna
		nil,
		{
			zone = 971,
			{"Quests",
	...
	desc[455] = { --  971/976, 455, Millhouse Manastorm
		nil,
		{
			zone = 971,
			{"Requirements",
	...
	desc[458] = { --  971/976, 458, Vindicator Heluun / Cacklebone
		nil,
		{
			zone = 971,
			{"Requirements",
	...
	desc[463] = { --  971/976, 463, Daleera Moonfang (A) / Ulna Thresher (H)
		nil,
		{
			zone = 971,
			{"Missions", 91}
...
--[=[ anywhere in draenor ]=]
	desc[194] = { --  962, 194, Phylarch the Evergreen
		{
			zone = 962,
	...
	desc[195] = { --  962, 195, Weldon Barov (A) / Alexi Weldon (H)
		{
			zone = 962,
			{"Requirements",
	...
	desc[465] = { --  962, 465, Harrison Jones
		nil,
		{
			zone = 962,
...
--[=[ dungeons ]=]
	...
	desc[178] = { --  995, 178, Leeroy Jenkins
		{
			zone = 995,
			zoneType = "dungeon",
			{"Achievements", 9058}
...
--[=[ raids ]=]
	desc[225] = { --  988, 225, Aknor Steelbringer
		{
			zone = 988,
			zoneType = "raid",
			{"Achievements", 8929}
...
--[=[ ashran ]=]
	desc[459] = { --  1009/1011, 459, Cleric Maluuf (A) / Karg Bloodfury (H)
		nil,
		{
			zone = 1009,
	...
	desc[460] = { --  1009/1011, 460, Felbast
		nil,
		{
			zone = 1009,
	...
	desc[462] = { --  1009/1011, 462, Dawnseeker Rukaryx
		nil,
		{
			zone = 1009,
	...
	desc[467] = { --  1009/1011, 467, Fen Tao
		nil,
		{
			zone = 1009,
	...
	--[=[ 945 Tanaan jungle ]=]
	desc[468] = { -- 945, 468, Oronok Torn-heart
		{
			zone = 945,
			{"Quests",
	...
	desc[581] = { -- 945, 581, Dowser Bigspark / Dowser Goodwell
		nil,
		{
			zone = 945,
	...
	desc[582] = { -- 945, 582, Solar Priest Vayx
		nil,
		{
			zone = 945,
